...
void send_test_data_ndev(int client_fd)
{
    ...
    unsigned char rs485_data_1_to_2[] = {0x41, 0x42, 0x45, 0x46, 0x47};
    unsigned char rs485_data_2_to_1[] = {0x43, 0x44, 0x48, 0x49, 0x4A};
    unsigned char rs485_data_3_to_4[] = {0x49, 0x4A, 0x4B, 0x4C, 0x4D};
    unsigned char rs485_data_4_to_3[] = {0x4E, 0x4F, 0x50, 0x51, 0x52};
    unsigned char rs232_data_1[] = {0x55, 0x66, 0x6A, 0x6B};
    unsigned char rs232_data_2[] = {0x77, 0x88, 0x8C, 0x8D};
    unsigned char can_data_1_to_2[] = {0xCC, 0xCD, 0xCE};
    unsigned char can_data_2_to_1[] = {0xDD, 0xDE, 0xDF};
